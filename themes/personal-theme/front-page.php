    ...
    <main id="main">
        ...
        <div class="intro">
            ...
            <div class="intro-images">
                ...
                <div class="intro-images__image">
                    ...
                    <div class="intro-images__container"></div>
                </div>
            </div>
        ...
        <div class="about" id="index__about">
            ...
            <div class="about__img">
                <img src="<?php echo get_theme_file_uri('/src/img/main-about-img.jpg'); ?>" alt="Bibliothèque de L'image Sans Nom" height="940" width="960">
            </div>
        </div>
    </main>
